...
import 'package:cp_project/featurs/home/presentation/pages/service_details.dart';
import 'package:cp_project/featurs/home/presentation/widgets/category_card.dart';
...
class _CategoryScreenState extends State<CategoryScreen> {
        ...
        actions: [
          AnimSearchBar(
            ...
            onSubmitted: (value) {
              ...
              context.read<GetDataBloc>().emit(DataIsHereState(servicedata: searchlist!));
            },
          ),
          IconButton(
            onPressed: () {},
      ...
      body: CustomScrollView(
        slivers: [
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) => RawChipWidget(
                      ...
                      onSelected: (value, label) {
                        setState(() {
                          context.read<GetDataBloc>().add(CallServerEvent(
          ...
          SliverPadding(
            ...
            sliver: BlocBuilder<GetDataBloc, GetDataState>(
  ...
  Map<int, String> checkCategory() {
    ...
    if (widget.categoryName == 'Mechanique') {
  ...
  void getdata() async{
    dynamic tempo = await BlocProvider.of<GetDataBloc>(context).getServicesUseCase('');
    tempo.fold(
            (l) => print('-----------------ggbloc--->$l'),
            (r) => allDataList = r
    );

...
class ChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (_) => locator<ChatBloc>()..add(LoadConversationsEvent()),
        child: SafeArea(
          child: Scaffold(
                  ...
                  child: Stack(
                    children: <Widget>[
                      BlocBuilder<ChatBloc, ChatState>(
                        buildWhen: (_, c) => c is! LoadMessagesCompletedState,
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return Conversation(
                                    ...
                                    name: state.convs[index].receiverUser.name,
                                    receiver:
                                        state.convs[index].receiverUser.id,
                                    lastMessage: state.convs[index].lastMessage,
                                    avatar:
                                        'https://randomuser.me/api/portraits/men/$index.jpg',
                                    time: timeago.format(state
                                        .convs[index].lastMessage.createdAt),
